...
public class lopezJohnSexoDTO {
    ...
    public lopezJohnSexoDTO(){}
    public lopezJohnSexoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion, String estado,
