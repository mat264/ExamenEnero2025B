...
public class lopezJohnPersonaTipoDTO {
    ...
    public lopezJohnPersonaTipoDTO(){}
    public lopezJohnPersonaTipoDTO(Integer idCatalogo, Integer idCatalogoTipo, String nombre, String descripcion,
